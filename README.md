...
Il dato giornaliero viene rilasciato quotidianamente dall'Istituto Superiore di Sanità in [questa repository](https://github.com/pcm-dpc/COVID-19/tree/master/).
