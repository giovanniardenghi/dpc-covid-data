...
state_group = {'Asintomatico':'Infected',
               'Pauci-sintomatico': 'Infected',
               'Lieve': 'Infected',
               'Severo':'Infected',
               'Critico':'Infected'
               }
...
if ignore_sex:
    ...
    sesso_eta['Casi'] = sesso_eta['Casi'] - sesso_eta['Deceduti'] - stato_clinico.xs('Infected', level='Stato').values.flatten()
else:
...
stato_clinico_perc.reset_index().to_csv('SUIHTER/stato_clinico_all_ages.csv',index=None)
